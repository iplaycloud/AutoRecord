...
public class FrontVideoDbHelper extends SQLiteOpenHelper {
	private static final int DATABASE_VERSION = 2;
	private static final String DATABASE_NAME = "video_front";
	...
	public FrontVideoDbHelper(Context context) {
